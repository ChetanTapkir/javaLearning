const person = {
    ...
    age: 23,
    name: "Billgates",
    speak: function(){console.log(`he i can speak hindi,english`);}
  }
...
marks :{science : 70,
        math : 90,
        english :87,
        add : function(){return this.science+this.english+this.math}
     },
age : 50,
...
console.log(`accesss proprties in nested object`);
